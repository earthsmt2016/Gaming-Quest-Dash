...
export default function QuestTable({ entries, onEdit, onSave }: QuestTableProps) {
  ...
  const startEdit = (id: string, field: 'game' | 'action', value: string) => {
      ...
      <article style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', gap: '12px', marginBottom: '12px' }}>
          <div>
            ...
            <div className="mini">Sorted newest first · swipe to scroll on mobile · double-click title or action to edit</div>
          </div>
        </div>
        <div style={{
          overflowX: 'auto',
